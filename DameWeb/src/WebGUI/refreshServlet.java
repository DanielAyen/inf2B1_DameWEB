					...
					if (!spiel.getBrett().getBrettFeldIndex(i, j).getIstBelegt()) {
						...
						if (fig.getFarbe() == FarbEnum.SCHWARZ) {
							...
							if (FarbEnum.WEIß == spiel.getAmZug()) {
								...
								ausgabe += "<td><a href=zugServlet?X=" + i + "&Y=" + j + "><img src=\"SteinWG2.png\" alt=\"W X:" + i + "Y:" + j + "\"></a></td>";
								cnt++;
								if (spiel.getBrett().getBrettFeldIndex(i, j).getSpielfigur().getDame(fig)) {
									// buttonArray[zeile][spalte].setIcon(dameWG);
									ausgabe += "<td><a href=zugServlet?X=" + i + "&Y=" + j + "><img src=\"dameWG.png\" alt=\"W X:" + i + "Y:" + j + "\"></a></td>";
									cnt++;
								}
							} else {

								// buttonArray[zeile][spalte].setIcon(figurw);
								ausgabe += "<td><a href=zugServlet?X=" + i + "&Y=" + j + "><img src=\"FeldSSteinW.png\" alt=\"W X:" + i + "Y:" + j + "\"></a></td>";
								cnt++;
								if (fig.getDame(fig)) {
									// buttonArray[zeile][spalte].setIcon(damew);
									ausgabe += "<td><a href=zugServlet?X=" + i + "&Y=" + j + "><img src=\"dameW.png\" alt=\"W X:" + i + "Y:" + j + "\"></a></td>";
									cnt++;
								}
							}
						}
